    ...
    <div className="font-sans">
      ...
      <section className="bg-gray-100 py-20">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            ...
            <button className="bg-white-500 hover:bg-gray-200 text-black font-bold py-3 px-6 rounded-lg mt-8">
              Learn More
            </button>
          </div>
          <div className="md:w-1/2">
            <Image src="/images/extruder-hero.png" alt="3D Filament Extruder" width={800} height={600} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-10">Precision</h2>
      ...
      <section className="bg-gray-100 py-20">
        <div className="container mx-auto flex flex-col-reverse md:flex-row items-center">
          ...
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0 md:pl-16">
            <h2 className="text-4xl font-bold mb-5">Our Revolutionary</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0 md:pr-16">
            <h2 className="text-4xl font-bold mb-5">Unmatched</h2>
            <p className="text-lg md:text-xl">
          ...
          <div className="md:w-1/2">
            <Image src="/images/extruder-action.png" alt="Extruder in Action" width={800} height={600} />
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-5">Elevate your 3D printing capabilities with our innovative 3D Filament Extruder</h2>
          <p className="text-lg md:text-xl">Discover the future of additive manufacturing</p>
        </div>
      </section>
